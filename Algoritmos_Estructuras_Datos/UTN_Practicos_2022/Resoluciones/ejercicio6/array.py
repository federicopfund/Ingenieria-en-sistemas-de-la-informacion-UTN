...
# Diseñar un algoritmo que vaya pidiendo números enteros al usuario hasta que ingrese un número menor a 0, almacenar los números en un array.
# Mostrar por pantalla el número menor, el mayor y la diferencia entre ambos.
def pedir_numeros() :
    numeros = np.array([])
